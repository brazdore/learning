...
import com.github.diegopacheco.sandbox.java.netflixoss.karyon.rest.ExpService;
...
@ArchaiusBootstrap
@KaryonBootstrap(name = "exp-microservice", healthcheck = HealthcheckResource.class)
@Modules(include = {
