...
public class SumService {
    ...
    public SumDataBag getSummary(String username) {
        var entry = getCountsOrThrow(username);
        return new SumDataBag(username, entry.getKey(), entry.getValue());
    }

    public String getSummaryAsJSON(String username) {
        return gson.toJson(getSummary(username));
    }
